...
MANUAL_BOARDS = [
    # ── LinkedIn ──
    ("LinkedIn — CD Remote",          "https://www.linkedin.com/jobs/search/?keywords=creative+director&f_WT=2&f_TPR=r86400"),
    ...
    ("LinkedIn — ECD Remote",         "https://www.linkedin.com/jobs/search/?keywords=executive+creative+director+remote&f_WT=2"),
    ("LinkedIn — Head of Design",     "https://www.linkedin.com/jobs/search/?keywords=head+of+design+remote&f_WT=2"),
    ("LinkedIn — AI Creative",        "https://www.linkedin.com/jobs/search/?keywords=ai+creative+director+remote&f_WT=2"),
    # ── No public API — check manually ──
    ("FlexJobs — Creative",           "https://www.flexjobs.com/remote-jobs/creative-director"),
    ...
    ("Jobot Creative",                "https://jobot.com/jobs?q=creative+director&remote=true"),
    ...
    ("Skip the Drive",                "https://www.skipthedrive.com/job-category/design-creative/"),
    ("4 Day Week — $100K+",           "https://4dayweek.io/remote-jobs"),
    ("Dynamite Jobs",                 "https://dynamitejobs.com/remote-jobs/creative"),
    ("Remote Circle",                 "https://remotecircle.com"),
    ("Hubstaff Talent",               "https://hubstafftalent.net/search/jobs?q=creative+director"),
    # ── AI / creative tech ──
    ("Superside — AI CD",             "https://careers.superside.com"),
    ...
    ("Roboflow — CD",                 "https://jobs.ashbyhq.com/roboflow"),
]
